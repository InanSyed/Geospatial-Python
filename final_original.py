...
within 100 km of an active volcano and visualises the results both as a static
matplotlib map and an interactive Folium map.  Paths are resolved relative to
...
CITIES_SHP = (
    BASE_DIR / "ne_10m_populated_places" / "ne_10m_populated_places.shp"
)
COUNTRIES_SHP = (
    BASE_DIR / "ne_50m_admin_0_countries" / "ne_50m_admin_0_countries.shp"
)
